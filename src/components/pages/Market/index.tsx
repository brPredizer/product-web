...
import { categoryColors, categoryLabels, statusLabels } from "./constants";
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <p className="text-3xl font-bold tracking-tight text-emerald-700">{yesPercent}%</p>
                        <p className="text-xs text-slate-500">R$ {yesPrice.toFixed(2)} por contrato</p>
                      </div>
                    </button>
                    ...
                    >
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <p className="text-3xl font-bold tracking-tight text-rose-700">{noPercent}%</p>
                        <p className="text-xs text-slate-500">R$ {noPrice.toFixed(2)} por contrato</p>
                      </div>
                    </button>
                  </div>
