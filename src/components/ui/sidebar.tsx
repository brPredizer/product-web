...
const Button = (ButtonModule as any).Button ?? (ButtonModule as any).default ?? ButtonModule
const Input = (InputModule as any).Input ?? (InputModule as any).default ?? InputModule
const Separator = (SeparatorModule as any).Separator ?? (SeparatorModule as any).default ?? SeparatorModule
const Sheet = (SheetModule as any).Sheet ?? (SheetModule as any).default ?? SheetModule
const SheetContent = (SheetModule as any).SheetContent ?? (SheetModule as any).default ?? SheetModule
const Skeleton = (SkeletonModule as any).Skeleton ?? (SkeletonModule as any).default ?? SkeletonModule
const TooltipProvider = (TooltipModule as any).TooltipProvider ?? (TooltipModule as any).default ?? TooltipModule
const Tooltip = (TooltipModule as any).Tooltip ?? TooltipModule
const TooltipTrigger = (TooltipModule as any).TooltipTrigger ?? TooltipModule
const TooltipContent = (TooltipModule as any).TooltipContent ?? TooltipModule
...
export const SidebarProvider = React.forwardRef<any, any>(
  (
    {
      defaultOpen = true,
      open: openProp,
...
export const Sidebar = React.forwardRef<any, any>(
  (
    ...
    return (
      <div ref={ref} className="group peer hidden text-sidebar-foreground md:block" data-state={state} data-collapsible={state === "collapsed" ? collapsible : ""} data-variant={variant} data-side={side}>
        <div className={cn("relative h-svh w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear", "group-data-[collapsible=offcanvas]:w-0", "group-data-[side=right]:rotate-180", variant === "floating" || variant === "inset" ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]" : "group-data-[collapsible=icon]:w-[--sidebar-width-icon]", className)} />
        <div className={cn("fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex", side === "left" ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]" : "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]", variant === "floating" || variant === "inset" ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]" : "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=right]:border-l")} {...props}>
          <div data-sidebar="sidebar" className={cn("flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow")}>{children}</div>
        </div>
      </div>
    )
  }
...
export const SidebarTrigger = React.forwardRef<any, any>(({ className, onClick, asChild = false, ...props }, ref) => {
...
export const SidebarRail = React.forwardRef<any, any>(({ className, ...props }, ref) => {
  const { toggleSidebar } = useSidebar()
...
export const SidebarInset = React.forwardRef<any, any>(({ className, ...props }, ref) => {
  return (
...
export const SidebarInput = React.forwardRef<any, any>(({ className, ...props }, ref) => (
...
export const SidebarHeader = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <div ref={ref} data-sidebar="header" className={cn("flex flex-col gap-2 p-2", className)} {...props} />
))
SidebarHeader.displayName = "SidebarHeader"

export const SidebarFooter = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <div ref={ref} data-sidebar="footer" className={cn("flex flex-col gap-2 p-2", className)} {...props} />
))
SidebarFooter.displayName = "SidebarFooter"

export const SidebarSeparator = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <Separator ref={ref as any} data-sidebar="separator" className={cn("mx-2 w-auto bg-sidebar-border", className)} {...props} />
))
SidebarSeparator.displayName = "SidebarSeparator"

export const SidebarContent = React.forwardRef<any, any>(({ className, ...props }, ref) => (
...
export const SidebarGroup = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <div ref={ref} data-sidebar="group" className={cn("relative flex w-full min-w-0 flex-col p-2", className)} {...props} />
))
SidebarGroup.displayName = "SidebarGroup"

export const SidebarGroupLabel = React.forwardRef<any, any>(({ className, asChild = false, ...props }, ref) => {
...
export const SidebarGroupAction = React.forwardRef<any, any>(({ className, asChild = false, ...props }, ref) => {
...
export const SidebarGroupContent = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <div ref={ref} data-sidebar="group-content" className={cn("w-full text-sm", className)} {...props} />
))
SidebarGroupContent.displayName = "SidebarGroupContent"

export const SidebarMenu = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <ul ref={ref} data-sidebar="menu" className={cn("flex w-full min-w-0 flex-col gap-1", className)} {...props} />
))
SidebarMenu.displayName = "SidebarMenu"

export const SidebarMenuItem = React.forwardRef<any, any>(({ className, ...props }, ref) => (
...
export const SidebarMenuButton = React.forwardRef<any, any>(
...
export const SidebarMenuAction = React.forwardRef<any, any>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  const Comp: any = asChild ? Slot : "button"
...
export const SidebarMenuBadge = React.forwardRef<any, any>(({ className, ...props }, ref) => (
...
export const SidebarMenuSkeleton = React.forwardRef<any, any>(({ className, showIcon = false, ...props }, ref) => {
...
export const SidebarMenuSub = React.forwardRef<any, any>(({ className, ...props }, ref) => (
...
export const SidebarMenuSubItem = React.forwardRef<any, any>(({ ...props }, ref) => <li ref={ref} {...props} />)
SidebarMenuSubItem.displayName = "SidebarMenuSubItem"

export const SidebarMenuSubButton = React.forwardRef<any, any>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
