...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    <SheetPrimitive.Content ref={ref as any} className={cn(sheetVariants({ side: side as any }), className)} {...props}>
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref as any} className={cn("text-lg font-semibold text-foreground", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description ref={ref as any} className={cn("text-sm text-muted-foreground", className)} {...props} />
))
