...
type BreadcrumbLinkProps = React.AnchorHTMLAttributes<HTMLAnchorElement> & { asChild?: boolean; className?: string }

export const BreadcrumbLink = React.forwardRef<any, BreadcrumbLinkProps>(({ asChild, className, ...props }, ref) => {
...
type SeparatorProps = React.HTMLAttributes<HTMLLIElement> & { children?: React.ReactNode }

export const BreadcrumbSeparator = ({ children, className, ...props }: SeparatorProps) => (
