...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label ref={ref as any} className={cn("px-2 py-1.5 text-sm font-semibold", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator ref={ref as any} className={cn("-mx-1 my-1 h-px bg-muted", className)} {...props} />
))
