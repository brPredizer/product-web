...
const SavedCardItem: FC<{ method: PaymentMethod; isOnlyOne: boolean; onRemove: () => void; loading?: boolean }> = ({
  method,
  isOnlyOne,
  onRemove,
  loading,
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-4">
            ...
            <div className="sm:col-span-4 flex flex-col sm:flex-row gap-3 sm:justify-end sm:items-end">
              ...
              <Button className={`bg-emerald-600 hover:bg-emerald-700 ${fieldFocusClass}`} onClick={addPix} disabled={loading}>
                Adicionar
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-4">
            ...
            <div className="sm:col-span-3">
              ...
              <Input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setBankAccount((p) => ({ ...p, accountNumber: e.target.value }))}
                className={`mt-1 ${fieldFocusClass}`}
            ...
            <div className="sm:col-span-2">
              ...
              <Input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setBankAccount((p) => ({ ...p, accountDigit: e.target.value }))}
                className={`mt-1 ${fieldFocusClass}`}
                placeholder="Ex: 7"
                inputMode="numeric"
              />
            ...
            <div className="sm:col-span-12 flex flex-col sm:flex-row gap-3 sm:justify-end sm:items-end">
              ...
              <Button className={`bg-emerald-600 hover:bg-emerald-700 ${fieldFocusClass}`} onClick={addBankAccount} disabled={loading}>
                Adicionar conta
              </Button>
            </div>
          </div>
                ...
                <div key={method.id} className="rounded-xl border bg-white p-4 shadow-sm">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">Digito {method.accountDigit} - {method.accountType}</p>
                    </div>
                    <Button
                      variant="outline"
                      size="sm"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-4">
              <div className="sm:col-span-5">
                ...
                <Input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => setCardForm((p) => ({ ...p, holder: e.target.value }))}
                  className={`mt-1 ${fieldFocusClass}`}
              ...
              <div className="sm:col-span-7">
                ...
                <Input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => setCardForm((p) => ({ ...p, number: e.target.value }))}
                  inputMode="numeric"
                  className={`mt-1 ${fieldFocusClass}`}
              ...
              <div className="sm:col-span-6 flex flex-col sm:flex-row gap-3 sm:justify-end sm:items-end">
                ...
                <Button className={`bg-emerald-600 hover:bg-emerald-700 ${fieldFocusClass}`} onClick={addCard} disabled={loading}>
                  Adicionar cartao
                </Button>
              </div>
            </div>
