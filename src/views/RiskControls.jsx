...
export default function RiskControlsPage({ user }) {
  const queryClient = useQueryClient();

  const { data: limits } = useQuery({
    queryKey: ['risk-limits', user?.id],
    queryFn: async () => {
      const result = await mockApi.entities.UserRiskLimits.filter({ user_id: user.id });
  ...
  const updateLimitsMutation = useMutation({
    mutationFn: async (data) => {
      if (limits?.id) {
        return mockApi.entities.UserRiskLimits.update(limits.id, data);
      } else {
        return mockApi.entities.UserRiskLimits.create({ ...data, user_id: user.id });
      }
    },
    onSuccess: () => {
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, daily_deposit_limit: e.target.value }))}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, weekly_deposit_limit: e.target.value }))}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, monthly_deposit_limit: e.target.value }))}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, daily_loss_limit: e.target.value }))}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, weekly_loss_limit: e.target.value }))}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, monthly_loss_limit: e.target.value }))}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, funding_cap: e.target.value }))}
              />
            </CardContent>
          </Card>
